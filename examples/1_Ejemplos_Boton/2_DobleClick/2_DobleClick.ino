...
void setup()
{
  ...
  // Configura la función que se ejecutará cuando se pulse el boton dos veces seguidas
  boton.attachDoubleClick(doubleClick);
} 
...
// Función que se ejecuta cuando se pulsa el boton dos veces seguidas
void doubleClick()
{
  Serial.println("x1");
